...
namespace VSGComputers.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(StaticDependencies.Role_User_Customer).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(StaticDependencies.Role_Employee)).GetAwaiter().GetResult();
            }
            Input = new()
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, StaticDependencies.Role_User_Customer);
                    }
